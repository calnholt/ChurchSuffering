...
public sealed class VisualEffectSequenceAuthoringTests
{
	...
	{
		var entityManager = new ChurchSuffering.ECS.Core.EntityManager();
	...
	private static string VisualSignature(System.Collections.Generic.IReadOnlyList<ChurchSuffering.ECS.Data.VisualEffects.VisualEffectBeat> beats)
	{
