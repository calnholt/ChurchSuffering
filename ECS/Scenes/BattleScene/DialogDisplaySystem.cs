    ...
    public class DialogDisplaySystem : Core.System
    {
        ...
        internal static string ResolvePortraitAssetName(string actor)
        {
            ...
            return actor.Trim().ToLowerInvariant() switch
            {
                ...
                "horde" => EnemyPortraitContent.ToAssetName("horde"),
                "skeleton" => EnemyPortraitContent.ToAssetName("skeleton"),
                "sand_corpse" => EnemyPortraitContent.ToAssetName("sand_corpse"),
                "fallen shepherd" => EnemyPortraitContent.ToAssetName("fallen_shepherd"),
                "nun" => "character/nun",
