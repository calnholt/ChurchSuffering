namespace Crusaders30XX.ECS.Systems
{
	internal static class WayStationSceneConstants
	{
		...
		public const string MastheadName = "WayStation_PenanceMasthead";
		public const string MastheadRuleName = "WayStation_PenanceMastheadRule";
		public const string TrackLabelName = "WayStation_PenanceTrackLabel";
		public const string TrackName = "WayStation_PenanceTrack";
		public const string TrackFillName = "WayStation_PenanceTrackFill";
		public const string FooterName = "WayStation_PenanceFooter";
		public const string NodePrefix = "WayStation_PenanceNode_";
		public const string TallyPrefix = "WayStation_PenanceTally_";
		public const string CloseButtonName = "WayStation_ClimbModalClose";
		public const string SwordButtonName = "WayStation_Button_Sword";
		public const string DaggerButtonName = "WayStation_Button_Dagger";
