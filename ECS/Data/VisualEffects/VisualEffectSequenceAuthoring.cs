...
public static class VisualEffectSequenceAuthoring
{
	...
	private static VisualEffectSequence CreateStructuredCardFallback(CardBase card)
	{
		...
		var fallbackId = attacksEnemy ? CardId.Strike : CardId.Colorless3Block;
