			...
			new Dictionary<string, DialogDefinition>(StringComparer.OrdinalIgnoreCase)
			{
				...
				["waystation_keeper"] = new DialogDefinition
				{
					...
					segments = new Dictionary<string, List<DialogLine>>
					{
						...
						[
							...
							new() { actor = "Keeper", message = "Heaven's Gate and the climbs to get there are misbehaving. Souls leave for purgation, demons appear in their path." },
							new() { actor = "Keeper", message = "Demons in Purgatory...never thought I'd see the day." },
				...
				["waystation_elias"] = new DialogDefinition
				{
					...
					segments = new Dictionary<string, List<DialogLine>>
					{
						...
						["dialogue_3"] =
						[
							new() { actor = "Elias", message = "I remembered Gerard's mother today. After the war, I brought her his medal and let her thank me as if I'd been loyal to him." },
							new() { actor = "Elias", message = "I told myself silence was mercy because she was already grieving." },
				...
				["desert_3"] = Lines("desert_3",
					...
					("Crusader", "*stops, removes helmet* Eternal rest grant unto them, O Lord. May they find in death the peace they never knew in life."),
					("Crusader", "*replaces helmet* Their souls still need our prayers, Replacement. But right now, the living need our swords."),
